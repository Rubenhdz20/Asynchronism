// Si se les hace complicado entender lo que se vió en la clase les recomiendo documentar el código, ir linea por linea, indagar y consultar que hace cada método, cada función, cada atributo, así es mucho más facil comprender. Les dejo el mio documentado, espero sea de gran ayuda:
...
fetchData(`${API}/products`, function (error1, data1) {
    ...
    //se invoca nuevamente la función fetchData con el fin de acceder a un objeto puntual del arreglo data1, se envia como parámetros la url de la API apuntando al atributo ID del primer objeto de arreglo data1 y nuevamente una función anónima.
